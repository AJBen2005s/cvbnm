...
const Home = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:3000/form/room-stats') // Replace this with the correct API endpoint for room stats
            .then(response => {
        ...
        axios.get('http://localhost:3000/form/rooms') // Replace this with the correct API endpoint for rooms
            .then(response => {
